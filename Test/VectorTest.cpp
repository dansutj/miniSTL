...
namespace miniSTL {
	namespace VectorTest {
		...
		void testCase1() {
			...
			assert(miniSTL::Test::container_equal(v3, v4));
			...
			assert(miniSTL::Test::container_equal(v5, v6));
		}
		void testCase2() {
			...
			auto v7 = std::move(v3);
			auto v8 = std::move(v4);
			assert(miniSTL::Test::container_equal(v7, v8));
		}
		void testCase3() {
			tsVec<int> v1, v2;
			for (int i = 0; i != 100; ++i) {
		...
		void testCase10() {
			...
			assert(miniSTL::Test::container_equal(foo, stdVec < int > { 100, 100, 100 }));
			assert(miniSTL::Test::container_equal(bar, stdVec < int > {200, 200}));

			foo.swap(bar);
			assert(miniSTL::Test::container_equal(bar, stdVec < int > { 100, 100, 100 }));
			assert(miniSTL::Test::container_equal(foo, stdVec < int > {200, 200}));
		}
		void testCase11() {
