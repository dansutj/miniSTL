...
namespace miniSTL
{
	...
	{
		template<class T>
		class dq_iter : public iterator<random_access_iterator_tag, T>
		{
		private:
			template<class T, class Alloc>
			friend class miniSTL::deque;

		private:
			typedef miniSTL::deque<T>* cntrPtr;
			size_t mapIndex_;
			T* cur_;
			cntrPtr container_;
	...
	private:
		template<class T>
		friend class miniSTL::Detail::dq_iter;
